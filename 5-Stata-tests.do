...
eststo: reghdfe lbw i.n_cat i.($controls) c.maternal_age , vce(cluster county_fips) absorb(county_fips#birth_year  birth_year#conception_quarter)

margins , dydx(n_cat)
margins , dydx(n_cat) mcompare(sidak)


eststo: reghdfe ptb i.n_cat i.($controls) c.maternal_age , vce(cluster county_fips) absorb(county_fips#birth_year  birth_year#conception_quarter)

margins , dydx(n_cat)
margins , dydx(n_cat) mcompare(sidak)


eststo: reghdfe vlbw i.n_cat i.($controls) c.maternal_age , vce(cluster county_fips) absorb(county_fips#birth_year  birth_year#conception_quarter)

margins , dydx(n_cat)
margins , dydx(n_cat) mcompare(sidak)

eststo: reghdfe vptb i.n_cat i.($controls) c.maternal_age , vce(cluster county_fips) absorb(county_fips#birth_year  birth_year#conception_quarter)
